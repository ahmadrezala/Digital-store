...
const Categoriescreate = () => {
    ...
    function handelChangevarition(value){
        ...
        //    const getattributesid =[]
            ...
            //   for(let i=0 ; i< data.data.attributeall.length; i++){
            //     getattributes.push(data.data.attributeall[i].name)
            //     getattributesid.push(data.data.attributeall[i].id)

            //   }
            //   setAttributes(getattributes);
            //   setAttributeid(getattributesid)
        ...
        async function createcategories(e){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  axios.post('http://127.0.0.1:8000/api/categories', fData)
    ...
    return(
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <form action="" onSubmit={(e)=>{createcategories(e)}}>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    ...
                    <input onChange={(e) => {setImage(e.target.files[0])}} className="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>

                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">is_active</label>
                    <input onChange={(e)=>{setIs_active(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[100%]">
                    ...
                    <textarea onChange={(e)=>{setDescription(e.target.value)}} className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]" type="text"></textarea>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <label className="text-[#888]" htmlFor="">attributes</label>
                ...
                <label className="text-[#888]" htmlFor="">attribute-filter</label>
                ...
                dataKey='id'
                 textField='name'
                onChange={(id)=>{handelChangefilter(id)}}
                />;
                </div>
            ...
            <div className="flex justify-between pt-[10px]">
                ...
                <label className="text-[#888]" htmlFor="">attribute-varition</label>
                ...
                dataKey='id'
                 textField='name'
                onChange={(e)=>{handelChangevarition(e)}}
                />;
                </div>
