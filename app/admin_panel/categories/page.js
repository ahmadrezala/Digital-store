...
const Categorieslist = () => {
    ...
    return(
        ...
        <div className="pt-[90px] w-[90%]">
            <h2 className="text-white text-[24px] font-bold capitalize">categories list</h2>
        ...
        <div className="w-[90%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            <div className="w-full capitalize flex justify-between text-white border-b-[1px] pb-[20px]">
                ...
                <div>
                    <div className="flex items-center">
                        <Link href="/admin_panel/categories/create" className="rounded-[100px] text-[12px] text-white border p-[12px]">
                        create Categories
                        </Link>
                    </div>
                </div>
            ...
            {categories && categories.map((Categories) => (
                ...
                <div className="flex text-white capitalize" key={Categories.id}>
                    ...
                    <span className="w-[20%] mb-[5px] overflow-hidden">{Categories.is_active}</span>
