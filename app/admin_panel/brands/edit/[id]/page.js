        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    ...
                    <input  onChange={(e)=>{setName(e.target.value)}} defaultValue={brand.name} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" for="">slug</label>
                    <input defaultValue={brand.slug} onChange={(e)=>{setSlug(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    ...
                    <input defaultValue={brand.is_active} onChange={(e)=>{setIs_active(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
