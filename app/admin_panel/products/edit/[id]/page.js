   ...
   let arrcz = []
    ...
    function handelSku(e ,i){
        ...
        .then(data => {
            ...
            .then(data => {
                ...
                // console.log(data.data.attributeall.length);
                setCategories(data.data.categoryall)
                // setAttributeid(data.data.attributeall)
        ...
        async function products(e){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  axios.put('http://127.0.0.1:8000/api/products', fData)
                  ...
                  router.push('http://localhost:3000/admin_panel/products')
                }
              });
        ...
        //     const fData = new FormData()
        //     fData.append("primeryimg",primeryimg)
        ...
        //                 attributes:attcategorypost,
        //                 variationvalue:valuevariation,
    ...
    return(
        ...
        <div className="pt-[90px] w-[90%]">
            <h2 className="text-white text-[24px] font-bold capitalize">create categories</h2>
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <form encType="multipart/form-data" action="" onSubmit={(e)=>{products(e)}}>
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">name</label>
                    <input onChange={(e)=>{setName(e.target.value)}} defaultValue={product.name} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">

                <label className="text-[#888]" htmlFor="">brands</label>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">status</label>
                    <input onChange={(e)=>{setStatus(e.target.value)}} defaultValue={product.status} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex pt-[36px]">
                <div className="w-[100%]">
                    <label className="text-[#888]" htmlFor="">description</label>
                    <textarea onChange={(e)=>{setDescription(e.target.value)}} defaultValue={product.description} name="" id="" className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]"></textarea>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <label className="block mb-2 text-sm font-medium text-white dark:text-white" htmlFor="file_input">primery image</label>
                <input onChange={(e) => {setPrimeryimg(e.target.files[0])}} defaultValue={product.primeryimg} className="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>

                </div>
                <div className="w-[48%]">

                <label className="block mb-2 text-sm font-medium text-white dark:text-white" htmlFor="file_input">images</label>
                <input onChange={(e) => {handelImages(e)}} defaultValue={product.imgs} multiple className="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <label className="text-[#888]" htmlFor="">categories</label>
                ...
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">product price</label>
                    <input onChange={(e)=>{setProductprice(e.target.value)}} defaultValue={product.price} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
           ...
           <div className="flex flex-wrap justify-between pt-[10px] border-t-[1px] mt-[36px]">
            ...
            {attributecategory && attributecategory.map((val) =>{
                ...
                return(
                    ...
                    <div key={val.id} className="w-[48%] mt-[36px]">
                        ...
                        <label className="text-[#888]" htmlFor="">{val.name}</label>
                        <input onChange={(e)=>{handelsetAttcategorypost(e , val.id)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
            ...
            <div className='text-[#888] mt-[36px] text-[20px]'>{variationcatrgory ? variationcatrgory.name + ' :' : ''}</div>

            <div className="flex flex-wrap justify-between pt-[10px] border-t-[1px] mt-[36px]">

                <div className="w-[100%] mt-[36px]">

                    <i onClick={()=>{plusinput()}} className="bi bi-plus-lg text-white cursor-pointer"></i>
                    <i onClick={()=>{minusinput()}} className="bi bi-dash-lg text-white ml-3 cursor-pointer"></i>
                </div>
            ...
            return(
                ...
                <div key={val.id} className="w-[48%] mt-[36px]">
                    ...
                    <label className="text-[#888]" htmlFor="">value</label>
                    <input onChange={(e)=>{handelValuevariation(e ,index)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>

                </div>
                <div key={val.id} className="w-[48%] mt-[36px]">

                    <label className="text-[#888]" htmlFor="">price</label>
                    <input onChange={(e)=>{handelPrice(e ,index)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>

                </div>
                <div key={val.id} className="w-[48%] mt-[36px]">

                    <label className="text-[#888]" htmlFor="">	quantity</label>
                    <input onChange={(e)=>{handelQuantity(e ,index)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>

                </div>
                <div key={val.id} className="w-[48%] mt-[36px]">

                    <label className="text-[#888]" htmlFor="">sku</label>
                    <input onChange={(e)=>{handelSku(e ,index)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
