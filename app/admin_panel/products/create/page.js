        ...
        async function products(e){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  axios.post('http://127.0.0.1:8000/api/products', fData)
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    ...
                    <input onChange={(e)=>{setName(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    ...
                    <input onChange={(e)=>{setStatus(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">slug</label>
                    <input onChange={(e)=>{setSlug(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex pt-[36px]">
                <div className="w-[100%]">
                    ...
                    <textarea onChange={(e)=>{setDescription(e.target.value)}} name="" id="" className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]"></textarea>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <input onChange={(e) => {setPrimeryimg(e.target.files[0])}} className="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
                ...
                <input onChange={(e) => {handelImages(e)}} multiple className="block w-full text-sm text-gray-900 border border-gray-300  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    ...
                    <input onChange={(e)=>{setProductprice(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
