...
const Faqedit = () => {
    ...
    return(
        ...
        <div className="pt-[90px] w-[90%]">
            <h2 className="text-white text-[24px] font-bold capitalize">update faq</h2>
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">fullname</label>
                    <input  onChange={(e)=>{setFullname(e.target.value)}} defaultValue={faq.fullname} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">email</label>
                    <input defaultValue={faq.email} onChange={(e)=>{setEmail(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    ...
                    <input defaultValue={faq.is_active} onChange={(e)=>{setIs_active(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">phonenumber</label>
                    <input defaultValue={faq.phonenumber} onChange={(e)=>{setPhone(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">subject</label>
                    <input defaultValue={faq.subject} onChange={(e)=>{setSubject(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlFor="">message</label>
                    <input defaultValue={faq.message} onChange={(e)=>{setMessage(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex justify-between pt-[36px]">
                <div className="w-[100%]">
                    <label className="text-[#888]" htmlFor="">answer</label>
                    <textarea defaultValue={faq.answer} onChange={(e)=>{setAnswer(e.target.value)}} rows={5} className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
