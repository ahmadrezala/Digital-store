...
const Faqlist = () => {
    ...
    return(
        ...
        <div className="pt-[90px] w-[90%]">
            <h2 className="text-white text-[24px] font-bold capitalize">faqs list</h2>
        ...
        <div className="w-[90%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            <div className="w-full capitalize flex justify-between text-white border-b-[1px] pb-[20px]">
                ...
                <div>
                    <div className="flex items-center">
                        <Link href="/admin_panel/faqs/create" className="rounded-[100px] text-[12px] text-white border p-[12px]">
                        create faq
                        </Link>
                    </div>
                </div>
            ...
            {faqs && faqs.map((faq) => (
                ...
                <div className="flex text-white capitalize" key={faq.id}>
                    ...
                    <Link href={`/admin_panel/faqs/edit/${faq.id}`}><i className="bi bi-gear"></i></Link>
                    {/* <faqdelete id = {faq.id}/> */}
                </div>
                ))}
