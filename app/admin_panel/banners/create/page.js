    ...
    async function createbanners(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              axios.post('http://127.0.0.1:8000/api/banners', fData)
    ...
    return(
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    <label className="text-[#888]" for="">title</label>
                    <input onChange={(e)=>{setTitle(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex pt-[36px]">
                <div className="w-[100%]">
                    ...
                    <textarea onChange={(e)=>{setText(e.target.value)}} name="" id="" className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]"></textarea>
