...
const Banneredit = () => {
    ...
    async function createbanners(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              axios.put(`http://127.0.0.1:8000/api/banners/${banner.id}`, fData)
              ...
              router.push('http://localhost:3000/admin_panel/banners')
            }
          });
    ...
    useEffect(()=>{
        fetch(`http://127.0.0.1:8000/api/banners/${params.id}`)
        .then(res => res.json())
        .then(data => {
            console.log(data)
            setBanner(data.data);
    ...
    return(
        ...
        <div className="pt-[90px] w-[90%]">
            <h2 className="text-white text-[24px] font-bold capitalize">create banner</h2>
        ...
        <div className="w-[70%] bg-[#141a29] mt-[60px] p-[36px] rounded-[1.5rem]">
            ...
            <form action="" onSubmit={(e)=>{createbanners(e)}}>
            <div className="flex justify-between pt-[36px]">
                ...
                <div className="w-[48%]">
                    <label className="text-[#888]" htmlForfor="">title</label>
                    <input defaultValue={banner.title} onChange={(e)=>{setTitle(e.target.value)}} className="h-[48px] mt-[4px] w-full rounded-[30px]" type="text"/>
                </div>
            ...
            <div className="flex pt-[36px]">
                <div className="w-[100%]">
                    <label className="text-[#888]" htmlFor="">text</label>
                    <textarea defaultValue={banner.text}  onChange={(e)=>{setText(e.target.value)}} name="" id="" className="h-[100px] p-[10px] mt-[4px] w-full rounded-[30px]"></textarea>
