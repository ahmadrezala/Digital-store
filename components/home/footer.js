...
const Footer = () => {
    ...
    return(
        ...
        <div>
          ...
          <p className="py-3 text-gray-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod quasi excepturi
            et porro illum eos?</p>
        ...
        <div>
          ...
          <div className=" flex flex-wrap justify-evenly ">
            <div className="flex justify-center items-center w-[50%] md:w-[32%] mb-5">
              <img className="bg-white rounded-[20px] w-[90px] h-[90px] me-4" src="/homeImg/backPack.jpg" alt=""/>
              <div className="pt-[4px]">
